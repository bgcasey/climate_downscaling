...
# read csvs
alex_2019<-read.csv(file="0_data/external/iButton/alex/combined/Combined2019TempData.csv")
...
tj<-left_join(alex_2020_2021, mdf, by=c("temp_id", "month", "day", "year", "Value"))


test<-left_join(alex_2020_2021, mdf, by=c("temp_id", "month", "day", "year", "Value"))%>% distinct()


#rename columns so column names match and combine
...
/Volumes/Projects/climate_downscaling/0_data/external/iButton/alex/combined/Combined2020_2021TempData.csv
/Volumes/Projects/climate_downscaling/0_data/external/iButton/alex/combined_2019_2020_2021/Combined2019TempData.csv
