...
p_summer <- predict(gee_all_summer, brt_meanTemp_summer, const=add,
...
p_summer <- predict(gee_all_summer, brt_minTemp_summer, const=add,
...
p_winter <- predict(gee_all_winter, brt_minTemp_winter, const=add,
