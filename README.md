...
<td style="text-align:right;">
Canada ([2015](#ref-natural2015canadian))
</td>
</tr>
<tr>
<td style="text-align:left;">
...
<td style="text-align:left;">
Topographic Position Index, TPI neigborhoods range from 50-1000 meters.
</td>
<td style="text-align:right;">
23.19
</td>
...
<td style="text-align:left;">
Topographic Wetness Index: ln(α/tanβ)) where α=cumulative upslope
drainage area and β is slope ([Sørensen and Seibert
2007](#ref-sorensen2007effects))
</td>
<td style="text-align:right;">
92.77
</td>
<td style="text-align:right;">
Yamazaki et al. ([2019](#ref-yamazaki2019merit))
</td>
</tr>
<tr>
<td style="text-align:left;">
...
<td style="text-align:right;">
Survey ([2018](#ref-geologicalsurveyLandsat47Surface2018))
</td>
</tr>
<tr>
<td style="text-align:left;">
...
<td style="text-align:left;">
Enhanced Vegetation Index: G \* ((NIR - R) / (NIR + C1 \* R – C2 \* B +
L))
</td>
<td style="text-align:right;">
30.00
...
<td style="text-align:left;">
Bare Soil Index: ((R+SWIR) – (NIR+B)) / ((R+SWIR) + (NIR+B))
</td>
<td style="text-align:right;">
30.00
</td>
...
<td style="text-align:left;">
Soil Adjusted Vegetation Index: ((NIR - R) / (NIR + R + L)) \* (1 + L)
</td>
<td style="text-align:right;">
30.00
</td>
...
<td style="text-align:left;">
Leaf Area Index: 3.618 *(2.5 * ((NIR - R) / (NIR + 6 \* R - 7.5 \* B +
1)))-0.118
</td>
<td style="text-align:right;">
30.00
...
<td style="text-align:left;">
Normalized Difference Snow Index: (G - SWIR) / (G- SWIR)
</td>
<td style="text-align:right;">
30.00
</td>
...
<td style="text-align:right;">
Buchhorn et al. ([2020](#ref-buchhorn2020copernicus))
</td>
</tr>
<tr>
<td style="text-align:left;">
...
<td style="text-align:left;">
Forest type for all pixels with tree cover \> 1 %
</td>
<td style="text-align:right;">
100.00
</td>
...
<td style="text-align:left;">
Percent of forest vegetation cover
</td>
<td style="text-align:right;">
100.00
</td>
...
<td style="text-align:right;">
Heidinger et al. ([2014](#ref-heidinger2014noaa))
</td>
</tr>
<tr>
<td style="text-align:left;">
...
<td style="text-align:right;">
Abatzoglou et al. ([2018](#ref-abatzoglou2018terraclimate))
</td>
</tr>
<tr>
<td style="text-align:left;">
...
<td style="text-align:right;">
Theobald et al. ([2015](#ref-theobald2015ecologically))
</td>
</tr>
<tr>
<td style="text-align:left;">
...
<td style="text-align:left;">
model trained with GEDI LiDAR to retrieve canopy height from Sentinel-2
images
</td>
<td style="text-align:right;">
10.00
...
<td style="text-align:right;">
Lang et al. ([2022](#ref-lang2022high))
</td>
</tr>
<tr>
<td style="text-align:left;">
...
<td style="text-align:left;">
model trained with GEDI LiDAR to retrieve standard deviation of canopy
height from Sentinel-2 images
</td>
<td style="text-align:right;">
10.00
</td>
