...
```{r child = '1_code/r_notebooks/covariates_ibutton_deployment.Rmd'}
```
...
Download the Google Earth Engine scripts by using `git clone https://earthengine.googlesource.com/users/bgcasey/climate_downscaling` into your working directory. 


### Terrain metrics {-}
```{r child = '1_code/GEE/climate_downscaling/extract_terrain.js'}
```
